...
if (loggedInUserId !== 'null'){
  ...
  const aCreateUser = document.getElementById('createUser');

  aCreateUser.innerText = loggedInUserName;
  aCreateUser.href ='profile.html';

  // Vi ændrer Log ind link til Log ud
  const aLogIn = document.getElementById('logIn');
  aLogIn.href ='../general/index.html';
  aLogIn.innerText='Log ud';
  aLogIn.addEventListener('click', logOut);

  /* Andre menubar-elementer efter brugertype
